...
* --- 5) Estimação: Probit dinâmico RE + CRE + CI -----------------------------
...
* --- 6) AME (apenas sobre as covariáveis de interesse) -----------------------
margins, dydx( ///
    y_l1 ///
    dias_chuva_l1 aridez_evapo12_l1 ///
    alin_gov_fed alin_pref_fed ///
