...
*
*   Todas as colunas usam a MESMA amostra (período ${ano_ini}-${ano_fim}).
*   Nota: a col. (1) tem uma observação a mais por município pois não exige y_{t-1}.
*
...
* ==============================================================================
* (2) Probit RE Dinâmico (ingênuo)  — preparação da amostra dinâmica
* ==============================================================================
